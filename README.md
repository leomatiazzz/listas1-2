# Bootcamp Dev. Full Stack Jr. (+praTi & Codifica) 2026

## Resolução das listas 1 & 2
...
2. As questões estão divididas em 3 pastas. Liste elas:

```bash
list
```

Acesse a pasta referente:
...
## Feito pelo aluno: *Léo Matias Araújo*